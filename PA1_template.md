...
Now we will make a panel plot using `ggplot2` to show the time series plot of the 5 minute intervals (x-axis) and average number of steps taken across all weekday days and weekend days (y-axis). We could use lattice here, which might be easier, but I'm 100% committed to ggplot! 
